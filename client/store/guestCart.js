...
//   try {
//     const cart = await JSON.parse(localStorage.getItem('localCart'))
...
// export const addToGuestCartThunk = (itemId) => async dispatch => {
//   try {
//     const product = await axios.get(`/api/products/${itemId}`)
